...
HTML;
    ...
    <div id="about">
      ...
      <div class="full">
        ...
        <p>Click on a username or the player itself to open the full page for that channel. This icon: <a class="icon popout black"></a> will open a popout with the stream and its chat - you can use F11 to make it fullscreen. This icon: <a class="icon toggle black"></a> will show the stream on this page.</p>
        <p>The status updates every 60 seconds; this is shown at the bottom-right corner of the screen. You can disable this behaviour by clicking this icon at the top right of the page: <a class="icon updates black"></a> so it is no longer green: <a class="icon updates disable black"></a>.</p>
        ...
        <p>This page supports the following providers: <a href="https://beam.pro">Beam</a>, <a href="http://www.hitbox.tv">Hitbox</a>, <a href="http://www.twitch.tv">Twitch</a>, <a href="http://www.ustream.tv">Ustream</a>. We may add support for other providers if they provide suitable API functionality and there is demand from channel owners. As of February '16, <a href="http://www.livestream.com">Livestream</a> and <a href="http://www.own3d.tv">own3d</a> do not provide suitable APIs.</p>
